var Jsocket2 = /** @class */ (function () {
    ...
    Object.defineProperty(Jsocket2, "instance", {
        get: function () {
            if (!this._instance) {
                this._instance = new Jsocket2();
            }
     ...
     * @param upgroup 协议
     */
    Jsocket2.prototype.setUrl = function (host, port, secret) {
     ...
     * @param url
     */
    Jsocket2.prototype.open = function (url) {
        if (url !== void 0)
            this.url = url;
     ...
     * 关闭websocket连接
     * */
    Jsocket2.prototype.close = function (outer) {
     ...
     */
    Jsocket2.prototype.send = function (target, param, callback, loading) {
    ...
    /**移除所有回调事件,所有监听事件 */
    Jsocket2.prototype.removeAll = function (target) {
     ...
     * @param callback
     */
    Jsocket2.prototype.addListener = function (action, target, callback) {
     ...
     * @param callback
     */
    Jsocket2.prototype.removeListener = function (action, target, callback) {
     ...
     * @param callback
     */
    Jsocket2.prototype.removeAllListener = function (target, callback) {
        if (!target && !callback) {
            this.event.listener = {};
            return;
        }
     ...
     * @param loading
     */
    Jsocket2.prototype.addCallback = function (action, target, callback, loading) {
     ...
     * @param callback
     */
    Jsocket2.prototype.removeCallback = function (action, target, callback) {
     ...
     * @param callback
     */
    Jsocket2.prototype.removeAllCallback = function (target, callback) {
        if (!target && !callback) {
            this.event.callback = {};
            return;
        }
     ...
     * @param loading
     */
    Jsocket2.prototype.addAssign = function (what, targt, callback, loading) {
        if (!what)
            return;
     ...
     * @param callback
     */
    Jsocket2.prototype.removeAssign = function (what, target, callback) {
        if (what)
    ...
    /**移除所有指定的回调 */
    Jsocket2.prototype.removeAllAssign = function () {
        this.event.assign = {};
    };
    /**
     * 添加连接成功的监听
     ...
     * @param callback
     */
    Jsocket2.prototype.addConnect = function (target, callback) {
        if (!target || typeof (callback) !== 'function')
            return;
     ...
     * @param callback
     */
    Jsocket2.prototype.removeConnect = function (target, callback) {
        if (!target && !callback) {
            this.event.connect = [];
            return;
        }
     ...
     * @param callback
     */
    Jsocket2.prototype.addClose = function (target, callback) {
        if (!target || typeof (callback) !== 'function')
            return;
     ...
     * @param callback
     */
    Jsocket2.prototype.removeClose = function (target, callback) {
        if (!target && !callback) {
            this.event.close = [];
            return;
        }
     ...
     * @param callback
     */
    Jsocket2.prototype.addError = function (target, callback) {
        if (!target || typeof (callback) !== 'function')
            return;
     ...
     * @param callback
     */
    Jsocket2.prototype.removeError = function (target, callback) {
        if (!target && !callback) {
            this.event.error = [];
            return;
        }
    ...
    Jsocket2.prototype.startLoading = function () {
    ...
    Jsocket2.prototype.stopLoading = function () {
    ...
    Jsocket2.prototype.inArray = function (array, value) {
    ...
    Jsocket2._instance = null;
    return Jsocket2;
}());
//# sourceMappingURL=Jsocket2.js.map